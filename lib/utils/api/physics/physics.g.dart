...
final getPhysicsExperimentRecordsProvider =
    AutoDisposeFutureProvider<List<PhysicsExperimentRecord>>.internal(
      getPhysicsExperimentRecords,
      name: r'getPhysicsExperimentRecordsProvider',
      debugGetCreateSourceHash:
          const bool.fromEnvironment('dart.vm.product')
              ? null
              : _$getPhysicsExperimentRecordsHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
